...
public interface TicketService {
     ...
     * @param id
     * @param couponId
     * @param userId 明确传递的用户ID
     * @return
     */
    ResponseVO completeTicket(List<Integer> id, int couponId, int userId);
     ...
     * @return
     */
    ResponseVO completeByVIPCard(List<Integer> id, int couponId, int userId);
